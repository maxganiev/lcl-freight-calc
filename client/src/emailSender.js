...
export const emailSender = {
	...
	sendEmail: async function () {
		...
		const eHeaders = [
			...
			'<b> Порт доставки: </b>',
			'<b> Стоимость пикапа (USD): </b>',
			'<b> Стоимость фрахта (USD): </b>',
			'<b> Стоимость локальных расходов в стране отправки (USD): </b>',
			'<b> Стоимость локальных расходов в стране назначения (руб.): </b>',
